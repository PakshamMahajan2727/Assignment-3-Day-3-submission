//PROGRAM AND FUNCTION FOR DELETION OF NODE FROM END IN SINGLY LINKED LIST
...
int main()
{
	...
	printf("\nlink list after deletion from end is:\n");
	printll();
...
// FUNCTION FOR DELETION OF NODE FROM END IN LINKED LIST
